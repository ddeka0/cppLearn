...
int main() {
	...
	LineBreak;
	std::cout << __LINE__ <<" => Op : "<< R"(arr.m_data[0] = std::move(a);)" << std::endl;
	arr.m_data[0] = std::move(a);
	...
	std::cout << __LINE__ <<" => Op : "<< R"(arr.m_data[1] = std::move(b);)" << std::endl;
	arr.m_data[1] = std::move(b);
